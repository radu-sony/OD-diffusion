...
for size in sizes:
    for fff in fffs:
        ...
        # params["city_dataset_name"] = f'diffusion_NOD_h416_d32_Nikon750_{size}_0_Cityscapes_h416_ddim24_bl'
        ...
        # SONY
        params["nod_data_root_train"] = '/home/radu.berdan/datasets/NOD_h416_d32/'
        params["nod_train_ann_file"] = f'annotations/raw_new_Sony_RX100m7_train_{size}_0.json'

        params["city_data_root_train"] = '/home/radu.berdan/datasets/'
        params["city_dataset_name"] = f"diffusion_NOD_h416_d32_Sony_RX100m7_{size}_0_Cityscapes_h416_ddim24_bl"
        params["city_train_ann_file"] = 'annotations/train.json'

        params["data_root_test"] = '/home/radu.berdan/datasets/NOD_h416_d32/'
        params["test_data_prefix"] = 'raw_new_Sony_RX100m7_test/'
        params["test_ann_file"] = 'annotations/raw_new_Sony_RX100m7_test.json'
